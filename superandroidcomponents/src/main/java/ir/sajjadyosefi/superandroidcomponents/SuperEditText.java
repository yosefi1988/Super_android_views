package ir.sajjadyosefi.superandroidcomponents;
...
//            addTextChangedListener(this);
    ...
    private void setCustomFacility(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SuperEditText);
        int mode = a.getInteger(R.styleable.SuperEditText_modeI, 0);
        int lengthInput = a.getInteger(R.styleable.SuperEditText_lengthInput, 0);
